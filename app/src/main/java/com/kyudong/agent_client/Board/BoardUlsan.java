...
public class BoardUlsan extends Fragment implements LikeCountInterface {

    private RecyclerView boardUlsanRv;
    ...
    public BoardUlsan newInstance() {
        BoardUlsan fragment = new BoardUlsan();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ulsan, container, false);
        ...
        GetUlsanBoard getUlsanBoard = new GetUlsanBoard();

        try {
            JSONObject object = new JSONObject();
            object.put("region", 7);
            object.put("board_seq", 1000);
            getUlsanBoard.doGetRequest(url + "/board/get/userBoard/" + user_seqNo, object.toString());
    ...
    private void findViewById(View v) {
        boardUlsanRv = (RecyclerView) v.findViewById(R.id.ulsanRv);
        llm = new LinearLayoutManager(getContext());
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        adapter = new BoardRvAdapter(getContext(), boardRvItemArrayList, user_seqNo, this);

        boardUlsanRv.setHasFixedSize(true);
        boardUlsanRv.setLayoutManager(llm);
        boardUlsanRv.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                boardUlsanRv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                    @Override
                                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                        super.onScrolled(recyclerView, dx, dy);

                                        visibleItemCount = boardUlsanRv.getChildCount();
