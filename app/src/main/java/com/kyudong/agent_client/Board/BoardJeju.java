...
public class BoardJeju extends Fragment implements LikeCountInterface{

    private RecyclerView boardJejuRv;
    ...
    public BoardJeju newInstance() {
        BoardJeju fragment = new BoardJeju();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_jeju, container, false);
        ...
        GetJejuBoard getJejuBoard = new GetJejuBoard();

        try {
            JSONObject object = new JSONObject();
            object.put("region", 9);
            object.put("board_seq", 1000);
            getJejuBoard.doGetRequest(url + "/board/get/userBoard/" + user_seqNo, object.toString());
    ...
    private void findViewById(View v) {
        boardJejuRv = (RecyclerView) v.findViewById(R.id.jejuRv);
        llm = new LinearLayoutManager(getContext());
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        adapter = new BoardRvAdapter(getContext(), boardRvItemArrayList, user_seqNo, this);

        boardJejuRv.setHasFixedSize(true);
        boardJejuRv.setLayoutManager(llm);
        boardJejuRv.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                boardJejuRv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                    @Override
                                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                        super.onScrolled(recyclerView, dx, dy);

                                        visibleItemCount = boardJejuRv.getChildCount();
