...
public class BoardDaejeon extends Fragment implements LikeCountInterface {

    private RecyclerView boardDaejeonRv;
    ...
    public BoardDaejeon newInstance() {
        BoardDaejeon fragment = new BoardDaejeon();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_daejeon, container, false);
        ...
        GetDaejeonBoard getDaejeonBoard = new GetDaejeonBoard();

        try {
            JSONObject object = new JSONObject();
            object.put("region", 5);
            object.put("board_seq", 1000);
            getDaejeonBoard.doGetRequest(url + "/board/get/userBoard/" + user_seqNo, object.toString());
    ...
    private void findViewById(View v) {
        boardDaejeonRv = (RecyclerView) v.findViewById(R.id.daejeonRv);
        llm = new LinearLayoutManager(getContext());
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        adapter = new BoardRvAdapter(getContext(), boardRvItemArrayList, user_seqNo, this);

        boardDaejeonRv.setHasFixedSize(true);
        boardDaejeonRv.setLayoutManager(llm);
        boardDaejeonRv.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                boardDaejeonRv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                    @Override
                                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                        super.onScrolled(recyclerView, dx, dy);

                                        visibleItemCount = boardDaejeonRv.getChildCount();
