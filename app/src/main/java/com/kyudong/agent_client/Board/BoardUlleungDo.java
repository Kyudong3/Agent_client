...
public class BoardUlleungDo extends Fragment implements LikeCountInterface{

    private RecyclerView boardUlleungDoRv;
    ...
    public BoardUlleungDo newInstance() {
        BoardUlleungDo fragment = new BoardUlleungDo();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ulleungdo, container, false);
        ...
        GetUlleungBoard getUlleungBoard = new GetUlleungBoard();

        try {
            JSONObject object = new JSONObject();
            object.put("region", 10);
            object.put("board_seq", 1000);
            getUlleungBoard.doGetRequest(url + "/board/get/userBoard/" + user_seqNo, object.toString());
    ...
    private void findViewById(View v) {
        boardUlleungDoRv = (RecyclerView) v.findViewById(R.id.ulleungdoRv);
        llm = new LinearLayoutManager(getContext());
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        adapter = new BoardRvAdapter(getContext(), boardRvItemArrayList, user_seqNo, this);

        boardUlleungDoRv.setHasFixedSize(true);
        boardUlleungDoRv.setLayoutManager(llm);
        boardUlleungDoRv.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                boardUlleungDoRv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                    @Override
                                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                        super.onScrolled(recyclerView, dx, dy);

                                        visibleItemCount = boardUlleungDoRv.getChildCount();
