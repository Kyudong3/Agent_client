...
public class BoardGwangJu extends Fragment implements LikeCountInterface {

    private RecyclerView boardGwangjuRv;
    ...
    public BoardGwangJu newInstance() {
        BoardGwangJu fragment = new BoardGwangJu();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_gwangju, container, false);
        ...
        getGwangJuBoard getGwangJuBoard = new getGwangJuBoard();

        try {
            JSONObject object = new JSONObject();
            object.put("region", 3);
            object.put("board_seq", 1000);
            getGwangJuBoard.doGetRequest(url + "/board/get/userBoard/" + user_seqNo, object.toString());
    ...
    private void findViewById(View v) {
        boardGwangjuRv = (RecyclerView) v.findViewById(R.id.gwangjuRv);
        llm = new LinearLayoutManager(getContext());
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        adapter = new BoardRvAdapter(getContext(), boardRvItemArrayList, user_seqNo, this);

        boardGwangjuRv.setHasFixedSize(true);
        boardGwangjuRv.setLayoutManager(llm);
        boardGwangjuRv.setAdapter(adapter);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                boardGwangjuRv.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                    @Override
                                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                        super.onScrolled(recyclerView, dx, dy);

                                        visibleItemCount = boardGwangjuRv.getChildCount();
